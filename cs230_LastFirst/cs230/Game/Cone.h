...
class Cone : public CS230::GameObject {
public:
	Cone(Math::vec2 position, Ball* ball);

	GameObjectType Type() override { return GameObjectType::Cone; }
	std::string TypeName() override { return "Cone"; }
