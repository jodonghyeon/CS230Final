...
class Dumbbell : public CS230::GameObject {
public:
	Dumbbell(Math::vec2 position, Ball* ball);

	GameObjectType Type() override { return GameObjectType::Dumbbell; }
	std::string TypeName() override { return "Dumbbell"; }
